...
export function useKeyboard(keyMap: KeyMap, options: UseKeyboardOptions = {}) {
...
export function useArrowNavigation<T extends HTMLElement>(itemRefs: React.RefObject<T>[], options: {
    loop?: boolean;
    vertical?: boolean;
    horizontal?: boolean;
    onSelect?: (index: number) => void;
} = {}) {
    const { loop = true, vertical = true, horizontal = false, onSelect, } = options;
...
export function useFocusTrap(containerRef: React.RefObject<HTMLElement>, options: {
    enabled?: boolean;
    autoFocus?: boolean;
} = {}) {
