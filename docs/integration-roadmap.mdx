...
### Component Migration
- [ ] **Chat Interface** (0%)
  - [ ] Port chat container component
  - [ ] Adapt message bubbles for therapy context
...
- [ ] **Navigation Elements** (0%)
  ...
  - [ ] Port header components
  - [ ] Adapt breadcrumb navigation
  - [ ] Create mobile-responsive menu

- [ ] **Form Components** (0%)
  - [ ] Port input fields with validation
  - [ ] Implement textarea components
  - [ ] Add select dropdowns
  - [ ] Create custom radio/checkbox components
