...
<CardGroup cols={2}>
  ...
  <Card title="Multi-Factor Auth" icon="shield-check" href="#multi-factor-authentication">
...
<Info>Password requirements ensure strong security while maintaining usability</Info>
...
<Steps>
  ### Enable MFA
  Navigate to security settings and enable MFA
...
<CardGroup cols={2}>
  <Card title="Security Support" icon="headset" href="mailto:security@gradiant.dev">
