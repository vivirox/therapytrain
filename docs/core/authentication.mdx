...
description: 'Understanding TherapyTrain's authentication and authorization system'
---

## Overview

TherapyTrain uses Supabase Auth for secure user authentication and authorization. This system provides robust security features while maintaining a smooth user experience.
...
const jwtConfig = {
  expiresIn: '1h',
  algorithm: 'RS256',
  audience: 'https://api.therapytrain.ai'
}
```
