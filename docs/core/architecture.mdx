...
description: 'Understanding TherapyTrain's core architecture and components'
---

## Overview

TherapyTrain is built on a modern, scalable architecture that prioritizes security, real-time communication, and AI integration. The system consists of several key components working together to provide a seamless therapy platform.
