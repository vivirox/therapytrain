---
title: 'Test Patterns'
description: 'Common test patterns and best practices used in TherapyTrain'
---

# Test Patterns

This guide outlines the common test patterns and best practices used throughout TherapyTrain's test suite.
