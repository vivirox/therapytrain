...
description: 'Guide to running and managing tests in TherapyTrain'
---

# Test Execution

This guide covers how to run tests, configure test environments, and manage test execution in TherapyTrain.
...
```env
# Database
DATABASE_URL=postgresql://localhost:5432/therapytrain_test

# Redis
REDIS_URL=redis://localhost:6379/1

# Test Users
TEST_USER_EMAIL=test@therapytrain.ai
