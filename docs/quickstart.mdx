...
description: 'Get started with TherapyTrain in minutes'
---
...
```bash
git clone https://github.com/vivirox/therapytrain.git
cd therapytrain
```
...
<CardGroup>
  ...
  >
    Learn about TherapyTrain's architecture and key concepts
  </Card>
  <Card
...
For more help, check our [deployment guide](/deployment/requirements) or [contact support](mailto:support@therapytrain.ai).
