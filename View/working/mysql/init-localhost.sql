...
(1,'tenminutes','default','Every 10 minutes','MinutesInterval',10,'2024-07-10 05:21:00'),
(2,'onehour','default','Every hour','HoursInterval',1,'2024-07-10 05:21:00'),
(3,'sixhours','default','Every six hours','HoursInterval',6,'2024-07-10 05:21:00'),
(4,'twelvehours','default','Every twelve hours','HoursInterval',12,'2024-07-10 05:21:00'),
(5,'daily','default','Daily','DaysInterval',1,'2024-07-10 05:21:00'),
(6,'weekly','default','Weekly','DaysInterval',7,'2024-07-10 05:21:00');
...
(1,'storage-embeddings-rule','default','example-data-bucket','default','My storage server embeddings rule','*',NULL,NULL,'example-embeddings-bucket','example-graph-repository','example-vector-repository','http://localhost:8501/processor','LCProxy','http://localhost:8301/','',512,32,3,3,'http://localhost:8311/',16777216,NULL,'2024-07-10 05:09:32'),
(2,'crawler-embeddings-rule','default','example-data-bucket','default','My crawler embeddings rule','*',NULL,NULL,NULL,'example-graph-repository','example-vector-repository','http://localhost:8501/processor','LCProxy','http://localhost:8301/','',512,32,3,3,'http://localhost:8311/',16777216,NULL,'2024-07-10 05:09:32'),
(3,'lexi-embeddings-rule','default',NULL,'default','My Lexi embeddings rule','*',NULL,NULL,NULL,'example-graph-repository','example-vector-repository','http://localhost:8501/lexi/embeddings','LCProxy','http://localhost:8301/','',512,32,3,3,'http://localhost:8311/',16777216,NULL,'2024-07-10 05:09:32');
...
(1,'example-graph-repository','default','My LiteGraph instance','LiteGraph','http://localhost:8701/',NULL,NULL,NULL,NULL,0,'11111111-1111-1111-1111-111111111111','2024-07-10 05:09:32');
...
INSERT INTO `metadatarules` VALUES (1,'example-metadata-rule','default','example-data-bucket','default','example-metadata-rule','*',NULL,NULL,134217728,'http://localhost:8501/processor','http://localhost:8501/processor/cleanup','http://localhost:8501/processor/typedetector','http://localhost:8341/',2,2048,1920,256,'http://localhost:8321/',25,1,1,'http://localhost:8201/','Lexi','default','example-graph-repository','example-udr-bucket',NULL,'2024-07-10 05:09:32');
