...
export class SecurityService {
    ...
    async decryptData(encryptedData: EncryptedData): Promise<any> {
        try {
            const decrypted = AES.decrypt(encryptedData.data, this.encryptionKey, {
    ...
    async logAudit(userId: string, action: string, resource: string, status: 'success' | 'failure', metadata: Record<string, any> = {}): Promise<void> {
