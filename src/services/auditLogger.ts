...
export class AuditLogger {
     ...
     */
    public async logSecurityEvent(action: string, status: 'success' | 'failure', details: Record<string, any>, metadata: Partial<AuditEvent['metadata']> = {}): Promise<void> {
        await this.logEvent({
     ...
     */
    public async logProofEvent(sessionId: string, proofId: string, action: string, status: 'success' | 'failure', details: Record<string, any>): Promise<void> {
        await this.logEvent({
     ...
     */
    public async logDataAccess(userId: string, resourceType: string, resourceId: string, action: string, status: 'success' | 'failure', details: Record<string, any>): Promise<void> {
        await this.logEvent({
     ...
     * Log a system event
     */
    public async logSystemEvent(action: string, status: 'success' | 'failure', details: Record<string, any>): Promise<void> {
        await this.logEvent({
     ...
     */
    public async getSecurityAuditLogs(startDate: Date, endDate: Date): Promise<Array<AuditEvent>> {
        try {
