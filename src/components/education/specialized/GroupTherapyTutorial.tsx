...
export const GroupTherapyTutorial: React.FC<GroupTherapyTutorialProps> = ({
  userId,
  scenarioId,
  onComplete
}) => {
  ...
  const updateGroupDynamics = () => {
    const averageEngagement =
      memberStates.reduce((sum, member) => sum + member.engagement, 0) /
      memberStates.length;
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8">
            ...
            {memberStates.map(member => (
              <Card key={member.id} className="p-4">
                <div className="flex items-start justify-between">
                  ...
                  <Badge
                    variant={member.engagement > 70 ? 'default' : 'secondary'}
                  >
        ...
        <Card className="p-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <Progress value={groupDynamics.cohesion} className="h-2" />
            </div>
            <div>
              <div className="flex justify-between mb-1">
              ...
              <Progress value={groupDynamics.tension} className="h-2" />
            </div>
            <div>
              <div className="flex justify-between mb-1">
              ...
              <Progress value={groupDynamics.participation} className="h-2" />
            </div>
            <div>
              <div className="flex justify-between mb-1">
              ...
              <Progress value={groupDynamics.support} className="h-2" />
            </div>
          </div>
        </Card>
      </div>
      ...
      <Button
        ...
        disabled={currentTime < scenario.duration}
      >
        Complete Session
      </Button>
    </div>
