  ...
  if (currentTutorial && currentStep) {
    return (
      <div className="max-w-4xl mx-auto p-6 space-y-6">
        ...
        <Progress 
          value={(currentTutorial.steps.findIndex(s => s.id === currentStep.id) + 1) 
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-2xl font-bold">
                  {Object.values(skillProgression.skills).reduce(
                    (acc, skill) => acc + skill.completedTutorials.length, 
                    0
                  )}
                </div>
              </div>
