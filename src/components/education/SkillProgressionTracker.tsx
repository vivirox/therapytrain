    ...
    return (<div className="max-w-6xl mx-auto p-6 space-y-8">
      ...
      <Card className="p-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <Trophy className="w-12 h-12 text-primary"></Trophy>
        </div>

        <Progress value={calculateOverallProgress()} className="h-3 mb-4"></Progress>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
          <div className="flex items-center gap-3">
            <Target className="w-8 h-8 text-blue-500"></Target>
            <div>
          ...
          <div className="flex items-center gap-3">
            <Clock className="w-8 h-8 text-green-500"></Clock>
            <div>
          ...
          <div className="flex items-center gap-3">
            <Award className="w-8 h-8 text-yellow-500"></Award>
            <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {Object.entries(progression.skills).map(([skillId, skill]: any) => (<Card key={skillId} className="p-6">
            ...
            <Progress value={(skill.experience / (1000 * skill.level)) * 100} className="h-2 mb-4"></Progress>
