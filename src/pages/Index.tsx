        ...
        <div className="relative h-[400px] mb-24 grid grid-cols-2 gap-8">
          ...
          <div className="relative z-20 flex flex-col justify-start h-[267px] pt-12">
            <div className="backdrop-blur-md bg-[#0A0A0B]/40 p-8 rounded-2xl border border-white/10">
              ...
              <p className="text-l text-gray-300 max-w-2xl">
                Enhance your skills with our HIPAA-compliant, AI-powered
                platform. Experience challenging scenarios and receive real-time
                feedback to become an exceptional therapist.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-[#1A1A1D] p-8 rounded-lg">
              ...
              <p className="text-gray-400">
                Our platform ensures the highest standards of data protection
            ...
            <div className="bg-[#1A1A1D] p-8 rounded-lg">
              ...
              <p className="text-gray-400">
                Advanced encryption guarantees the confidentiality of all
                training sessions and user data.
              </p>
            </div>
            <div className="bg-[#1A1A1D] p-8 rounded-lg">
              ...
              <p className="text-gray-400">
                Receive immediate, AI-generated evaluations of your therapeutic
                approaches.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-[#1A1A1D] p-8 rounded-lg">
              ...
              <p className="text-gray-400">
                Experience a wide range of client presentations and therapeutic
                challenges.
              </p>
            </div>
            <div className="bg-[#1A1A1D] p-8 rounded-lg">
              ...
              <p className="text-gray-400">
                Earn certificates as you progress through different levels of
            ...
            <div className="bg-[#1A1A1D] p-8 rounded-lg">
              ...
              <p className="text-gray-400">
                Our AI adjusts the difficulty based on your performance,
            ...
            <div className="bg-[#1A1A1D] p-8 rounded-lg">
              ...
              <p className="text-gray-400">
                All simulations are grounded in the latest research and best
