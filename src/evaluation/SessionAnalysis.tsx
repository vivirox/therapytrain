...
const SessionAnalysis: React.FC<SessionAnalysisProps> = ({
  ...
  const [analysis, setAnalysis] = useState<{
    ...
    emotions: Record<string, { count: number; avgIntensity: number }>;
  ...
  const analyzeSession = (data: SessionData) => {
    const analysis = {
      ...
      emotions: {} as Record<string, { count: number; avgIntensity: number }>,
  ...
  const generateReport = () => {
    if (!sessionData || !analysis) return;
      ...
      <Tabs defaultValue="overview" className="w-full">
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-2">
                  {Object.entries(analysis.emotions).map(([emotion, data]) => (
              ...
              <div>
                ...
                <div className="space-y-2">
                  {Object.entries(analysis.defenses).map(([defense, count]) => (
        ...
        <TabsContent value="interventions">
          <Card className="p-4">
            ...
            <div className="space-y-4">
              {Object.entries(analysis.interventionEffectiveness).map(([approach, effectiveness]) => (
                <div key={approach}>
                  ...
                  <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                    <div 
                      ...
                      style={{ width: `${(effectiveness / 5) * 100}%` }}
                    />
                  </div>
                </div>
              ))}
                ...
                <div key={index} className="border-b last:border-0 pb-3">
                  ...
                  {message.analysis && (
                    <div className="flex flex-wrap gap-2 mt-1">
                      {message.analysis.patterns.map((pattern, i) => (
