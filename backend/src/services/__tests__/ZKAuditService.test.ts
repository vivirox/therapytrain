...
describe('ZKAuditService', () => {
    ...
    beforeEach(() => {
        ...
        zkAuditService = new ZKAuditService(mockSupabase, mockSecurityAuditService, 10, // smaller window for testing
    ...
    describe('recordAuditEvent', () => {
        ...
        it('should forward high severity events to security audit', async () => {
            ...
            expect(mockSecurityAuditService.recordAlert).toHaveBeenCalledWith(highSeverityEvent.type, highSeverityEvent.severity, highSeverityEvent.data);
        });
    ...
    describe('getHistoricalMetrics', () => {
        ...
        it('should handle Supabase errors in historical metrics', async () => {
            ...
            await expect(zkAuditService.getHistoricalMetrics(new Date(), new Date())).rejects.toThrow(error);
        });
    });
    describe('dashboard integration', () => {
        it('should handle dashboard client registration', () => {
            ...
            const closeHandler = (mockWebSocket.on as jest.Mock).mock.calls.find(call, unknown => call[0] === 'close')[1];
            closeHandler();
