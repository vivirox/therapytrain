...
export class HIPAAComplianceReportService {
    ...
    }): { complianceScore: number; riskLevel: ComplianceReport['summary']['riskLevel'] } {
    ...
    private calculateAccessScore(accessControl: ComplianceReport['accessControl']): number {
        ...
        score -= Math.max(
            0,
            accessControl.emergencyAccesses - this.assessmentCriteria.accessControl.maxEmergencyAccesses
