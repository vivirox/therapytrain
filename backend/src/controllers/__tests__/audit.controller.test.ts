...
describe('AuditController', () => {
    ...
    describe('getAuditLogs', () => {
        it('should return filtered audit logs', async () => {
            ...
            expect(mockSecurityAudit.getAuditLogs).toHaveBeenCalledWith(
                expect.any(Date),
                expect.any(Date),
    ...
    describe('getSecurityMetrics', () => {
        it('should return security metrics', async () => {
            ...
            await auditController.getSecurityMetrics(
                mockReq as Request,
                mockRes as Response,
                mockNext
            );
    ...
    describe('getSecurityAlerts', () => {
        it('should return recent security alerts', async () => {
            ...
            await auditController.getSecurityAlerts(
                mockReq as Request,
                mockRes as Response,
                mockNext
            );
    ...
    describe('getRateLimitEvents', () => {
        it('should return rate limit events for IP', async () => {
            ...
            await auditController.getRateLimitEvents(
                mockReq as Request,
                mockRes as Response,
                mockNext
            );
