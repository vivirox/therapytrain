...
export async function createApp() {
  ...
  app.post(
    ...
    async (
      req: TypedRequestBody<WebAuthnRegisterRequest>,
  ...
  app.post(
    ...
    async (
      req: TypedRequestBody<WebAuthnVerifyRequest>,
      res: TypedResponse<unknown>,
    ) => {
      try {
  ...
  app.post(
    ...
    async (
      req: TypedRequestBody<BackupCodeRequest>,
      res: TypedResponse<{ codes: string[] }>,
    ) => {
      try {
  ...
  app.post(
    ...
    async (
      req: TypedRequestBody<VerifyBackupCodeRequest>,
      res: TypedResponse<{ valid: boolean }>,
    ) => {
      try {
        const { userId, code } = req.body;
        const isValid = await accountRecoveryService.verifyBackupCode(
          userId,
          code,
        );
  ...
  app.post(
    "/api/auth/security-questions/set",
    async (
      req: TypedRequestBody<SecurityQuestionsRequest>,
  ...
  app.post(
    ...
    async (
      req: TypedRequestBody<VerifySecurityQuestionsRequest>,
      res: TypedResponse<{ valid: boolean }>,
    ) => {
      try {
        const { userId, answers } = req.body;
        const isValid = await accountRecoveryService.verifySecurityQuestions(
          userId,
          answers,
        );
        res.json({ valid: isValid });
